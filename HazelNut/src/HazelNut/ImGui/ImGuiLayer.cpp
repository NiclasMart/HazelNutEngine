...
namespace HazelNut {
	...
	bool ImGuiLayer::OnMouseButtonPressedEvent(MouseButtonPressedEvent& e)
	{
		...
		CORE_LOG_INFO("Mouse button down event on imgui");
		io.MouseDown[e.GetMousButton()] = true;
	...
	{
		ImGuiIO& io = ImGui::GetIO();
		CORE_LOG_INFO("Mouse button up event on imgui");
		io.MouseDown[e.GetMousButton()] = false;
		return false;
	}
