...
namespace HazelNut {
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		// we could generate more than one window, but we only want to initialize glfw once
		if (!s_GLFWInitialized)
		{
			int success = glfwInit();
			HZN_CORE_ASSERT(success, "Could not intialize GLFW!");
	...
	// Implements all important GLFW Callbacks
